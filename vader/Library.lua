...
-- Library init
    ...
    -- synca patch: filesystems are optional on some executors; never die here
    pcall(function()
    ...
    -- Font importing system (synca patch: fully guarded so executors without
    -- getcustomasset / filesystem / http still boot with a built-in font)
        pcall(function()
        ...
        if type(library.font) ~= "Font" then
